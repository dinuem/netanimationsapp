...
'netanimations.ethernet', 'netanimations.subnets', 'netanimations.subnet-mask'])
...
.config(function ($stateProvider, $urlRouterProvider, $translateProvider) {
  $stateProvider
    ...
    .state('app.subnet-mask', {
      url: '/subnet-mask',
      views: {
        'menuContent': {
          templateUrl: 'templates/subnet-mask.html',
          controller: 'SubnetMaskCtrl'
        }
      }
    })
    ;
  ...
  $translateProvider.translations('en', {
    ...
    SUBNETS_REALIZING_LIGIC_AND: 'Performing arithmetic "AND"',
    ...
    SUBNETS_PRESENTATION_03: 'When a host sends a packet, it performs the arithmetic AND (E) </ b> operation of the destination IP with the subnet mask to determine the destination network number.',
    ...
    SUBNETS_PRESENTATION_07: 'The router has a forwarding table that contains a subnet mask and a network address for each network. It performs the arithmetic AND between the destination IP with each subnet mask until it finds the appropriate network address.',
  ...
  $translateProvider.translations('pt-br', {
    ...
    SUBNETS_DESC: 'Apresentação de conceitos de transmissão de pacotes entre sub-redes.',
    SUBNETS_ICON: 'Ícone de animação Sub-redes',
    SUBNET_MASK: 'Máscara de sub-rede',
    SUBNETS_DESTINATION_IP: 'IP de destino',
    SUBNETS_CONVERTING_TO_BIT: 'Convertendo para binário',
    SUBNETS_REALIZING_LIGIC_AND: 'Realizando "E" aritmético',
    SUBNETS_CONVERTING_TO_DECIMAL: 'Convertento para decimal',
    ...
    SUBNETS_PRESENTATION_03: 'Quando um host envia um pacote, ele realiza a operação <b>aritmética AND (E)</b> do IP de destino com a máscara da sub-rede para determinar o número da rede de destino.',
    SUBNETS_PRESENTATION_04: 'Aqui, o IP de destino é <b>162.103.136.103</b>. Realizando o E aritmético do IP de destino com a máscara da sub-rede nós conseguimos o número da rede <b>162.103.128.0</b>, então o pacote pode ser enviado diretamente para o destinatário desde que esteja na mesma sub-rede.',
    ...
    SUBNETS_PRESENTATION_07: 'O roteador possui uma tabela de repasse que contém uma máscara de sub-rede e um endereço de rede para cada rede. Ele realiza o E aritmético entre o IP destino com cada máscara de sub-rede até encontrar o endereço de rede apropriado.',
    ...
    SUBNET_MASK_DESC: 'A importância da utilização da máscara de rede para criação de sub-redes lógicas.',
    SUBNET_MASK_ICON: 'Ícone de animação de máscara de sub-rede',
    SUBNET_MASK_DEFAULT_MASK: 'Máscara padrão',
    SUBNET_MASK_CONVERTING_TO_BIT: 'Convertendo para binário',
    SUBNET_MASK_BITS_ARE: 'Estes bits são para:',
    SUBNET_MASK_NET: 'Rede',
    SUBNET_MASK_HOST: 'Host',
    SUBNET_MASK_PRESENTATION_1: 'A seguir, tem-se uma rede conectada à Internet. O IP da rede é um <b>endereço Classe B</b>. Isso significa que 2 bytes identificam o host e 2 bytes a rede.',
    SUBNET_MASK_PRESENTATION_2: 'Como 2 bytes são utilizados para os hosts, é possível haver um total de 65536 endereços para uma dada rede Classe B.',
    SUBNET_MASK_PRESENTATION_3: 'Uma máscara de sub-rede é utilizada para <b>determinar quais bits serão usados para a rede e quais serão usados para os hosts</b>, os 16 bits da esquerda são a máscara padrão para endereços da Classe B.',
    SUBNET_MASK_PRESENTATION_4: 'Para utilizar eficientemente o espaço de endereçamento, precisamos dividir a rede em sub-redes lógicas.',
    SUBNET_MASK_PRESENTATION_5: 'Aqui nós criamos duas sub-redes estendendo a máscara da sub-rede em 1 bit. Agora a parte da rede é composta por 16 bits, a parte da sub-rede é composta por um bit e a parte dos hosts por 15 bits. Cada sub-rede é conectada em um switch.',
    SUBNET_MASK_PRESENTATION_6: 'Com 1 bit extra para a parte da rede, podendo assumir 1 ou 0, podemos criar duas redes lógicas.',
    SUBNET_MASK_PRESENTATION_7: 'Essas sub-redes podem futuramente serem quebradas em mais sub-redes de maneira similar. '
